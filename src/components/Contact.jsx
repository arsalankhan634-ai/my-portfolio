    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center">
          <div className="w-full md:w-1/2 bg-white p-8 rounded-lg shadow-lg">
            <form onSubmit={handleSubmit} ref={form}>
              <div className="mb-4">
                <label htmlFor="name" className="block text-xl font-medium text-secondary mb-2">Name</label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              <div className="mb-4">
                <label htmlFor="email" className="block text-xl font-medium text-secondary mb-2">Email Address</label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              <div className="mb-4">
                <label htmlFor="message" className="block text-xl font-medium text-secondary mb-2">Message</label>
                <textarea
                  id="message"
                  name="message"
              ...
              {status && (
                <p className="mt-4 text-center text-lg text-secondary">{status}</p>
              )}
            </form>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <h3 className="text-2xl font-semibold text-primary mb-4">Or reach me at</h3>
          <p className="text-lg">
            Email:{" "}
            <a href="mailto:arsalankhan634@gmail.com" className="text-primary">
